class ActionProvider {
  ...
  chooseAuthor = () => {
    console.log(this.storage.genre);
    if (this.storage.genre === "Comic/Cartoon") {
      const message = this.createChatBotMessage(
      ...
      this.addMessageToState(message);
    } else if (this.storage.genre === "Krimi") {
      const message = this.createChatBotMessage(
        "Von welchem Autor soll das Buch sein? Wenn du nach einem anderen Autor suchst, tippe den Namen ein.",
        {
          widget: "authorKrimi"
      ...
      this.addMessageToState(message);
    } else if (this.storage.genre === "Roman") {
      const message = this.createChatBotMessage(
        "Von welchem Autor soll das Buch sein? Wenn du nach einem anderen Autor suchst, tippe den Namen ein.",
        {
          widget: "authorRoman"
      ...
      this.addMessageToState(message);
    } else if (this.storage.genre === "Science Fiction") {
      const message = this.createChatBotMessage(
        "Von welchem Autor soll das Buch sein? Wenn du nach einem anderen Autor suchst, tippe den Namen ein.",
        {
          widget: "authorSciFi"
  ...
  recommendPopularity = () => {
    ...
    this.setStorage({ ...this.storage, bookStorage: recBooks.slice(0, 3) });
  ...
  recommendGenre = (g) => {
    ...
    if (this.storage.author === "") {
      ...
      const recBooks = this.books.filter((b) => {
        return b.genre === g && b.author === this.storage.author;
      });
      this.setStorage({ ...this.storage, bookStorage: recBooks.slice(0, 3) });
    }
    console.log(this.storage.bookStorage);
  ...
  recommendAuthor = (a) => {
    ...
    if (this.storage.genre === "") {
      ...
      const recBooks = this.books.filter((b) => {
        return b.author === a && b.genre === this.storage.genre;
      });
      this.setStorage({ ...this.storage, bookStorage: recBooks.slice(0, 3) });
    }
    console.log(this.storage.bookStorage);
